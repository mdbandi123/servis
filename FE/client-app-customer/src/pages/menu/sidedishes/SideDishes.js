...
import { SideDishesData } from './SideDishesList';
            ...
            <React.Fragment>
                <Box sx={pageContainer}>
                    <Stack sx={headerPage} direction='row' alignItems='center' alignContent='center' spacing={1}>
                        ...
                        <GlobalBlackHeader4 text='Side Dishes' />
                    </Stack>
                    <Grid2 container sx={centerAlignment} spacing={1}>
                        ...
                        <Grid2 item xs={12} sm={12} md={12} lg={12} lx={12}>
                            <GlobalBlackHeader5 text='No Side Dishes Found' />
                        </Grid2>
                        <Grid2 item xs={12} sm={12} md={12} lg={12} lx={12}>
                            <GlobalGreyBody2 text={`We couldn't find any Side Dishes. Admin might not have created yet.`} />
                        </Grid2>
                    </Grid2>
                </Box>
            </React.Fragment>
                ...
                <Grid2 container justifyContent='center'>
                    <Grid2 item>
                        <Grid2 container justifyContent='start' spacing={1}>
                            {SideDishesData.map((sideDishesList) => (
                                <Grid2 item xs={6} sm={6} md={4} lg={3} lx={3}>
                                    <Card sx={cardContainer}>
                                        <CardMedia component='img' height='140' image={sideDishesList.foodItemImage} alt={sideDishesList.foodItemName} />
                                        <CardContent sx={cardContent}>
                                            <Stack direction='column' spacing={2}>
                                                <Box>
                                                    <GlobalBlackHeader6 sx={itemNamePrice} text={sideDishesList.foodItemName} />
                                                    <GlobalPinkHeader6 sx={itemNamePrice} text={'$' + sideDishesList.foodItemPrice} />
                                                </Box>
                                                <Box >
