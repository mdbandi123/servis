    ...
    return (
        <FadeIn>
            <Grid2 sx={ [fullScreenDisplay, centerAlignment] } container>
                <Grid2 sx={ [forgotPasswordContainer] } xs={12} sm={12} md={8} lg={8} lx={8} item>
                    <Stack component='form' spacing={6}>
                        <Stack>
                            <GlobalIndigoHeader2 text='Forgot Password' />
                            <GlobalBlackHeader5 text={ `Enter your email to reset your password` } />
                        </Stack>
                        <Stack spacing={2}>
                            <Box>
                            ...
                            <Box>
                              <Stack direction='row' spacing={1} justifyContent='center'>
                                <Box onClick={() => navigate('/login')} sx={ backButton }>
                                  <GlobalGreyContainedButton text='Back' />
                                </Box>
                                <Box>
                                  <GlobalTealContainedButton text='Proceed' />
                                </Box>
                              </Stack>
                            </Box>
                        </Stack>
